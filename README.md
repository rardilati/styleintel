...
## Descripción
StyleIntel es un SaaS de análisis de tendencias de moda asiática que permite identificar qué estilos están creciendo mediante un dashboard visual con datos.

## Problema
Muchas tiendas online y creadores de contenido no saben qué tendencias de moda asiática están en auge ni cómo anticiparse a ellas.
...
##  Autor: Raquel
Proyecto desarrollado como portfolio para prácticas de desarrollo web.